...
<div class="contenido-electoral">
	<div class="electoral">
		<div class="imagen-electoral animated zoomIn">
			<img src="{{asset('web/img/servicios/sepsa.png')}}" alt="">
		</div>
		<article class="contenido-articulo animated fadeInRight">
			<h3>Pago de Servicios Eléctricos.</h3>
			<p>
			 Ahora puede realizar el pago de servicios eléctricos en nuestra oficina. Calle Topater N°5 (Entre Hoyos y Linares) <a href="{{route('ubicacion')}}">Ver mapa</a>.
			</p>
